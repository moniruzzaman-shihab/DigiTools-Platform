...
const Cart = ({ carts,setCarts }) => {
  ...
  return (
    <div className="p-8 border border-gray-100 shadow-md max-w-11/12 mx-auto">
      ...
      {
        carts.length===0 ? <><div className="flex flex-col items-center justify-center gap-3 bg-purple-100 rounded-md  mt-3 py-16 max-[540px]:py-10"><ShoppingCart className="text-purple-500 text-5xl"  /><p className="text-purple-500">Cart is empty</p></div></> : <> {carts.map((item) => (
